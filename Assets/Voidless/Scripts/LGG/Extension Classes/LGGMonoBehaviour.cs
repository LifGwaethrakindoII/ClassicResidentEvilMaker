...
/*===========================================================================
**
** Class:  LGGMonoBehaviour
**
** Purpose: A MonoBehaviour class that also overrides object.Equals() and
** object.GetHashCode so it can be used as a hashable key for HashSet<T>
** or Dictionary<K, V>.
**
**
...
namespace LGG
{
    public class LGGMonoBehaviour : MonoBehaviour, IEqualityComparer<LGGMonoBehaviour>
    {
    ...
    #region IEqualityComparer:
        ...
        public bool Equals(LGGMonoBehaviour a, LGGMonoBehaviour b)
        {
            return a.GetInstanceID() == b.GetInstanceID();
        }

        /// <returns>Returns a hash code for the specified object.</returns>
        public int GetHashCode(LGGMonoBehaviour reference)
        {
