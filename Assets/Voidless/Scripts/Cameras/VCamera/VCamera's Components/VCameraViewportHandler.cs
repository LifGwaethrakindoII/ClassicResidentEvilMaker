...
{
	private const float PLANE_NEAR_EPSILON = 0.0001f;

	[SerializeField] private CameraGrid _gridAttributes;
#if UNITY_EDITOR
	[Space(5f)]
	[Header("Gizmos' Attributes:")]
	[SerializeField] private Color centerColor;
	[SerializeField] private Color onRangeColor;
	[SerializeField] private Color offRangeColor;
	[SerializeField] private bool drawGrid;
#endif
	private CameraViewportPlane nearPlane;
...
#region UnityMethods:
	...
	private void DrawCameraGrid()
	{
		...
		Axes2D axesInside = /*Axes2DWithinGridFocusArea(vCamera.targetRetriever.GetTargetPosition());*/default(Axes2D);
