...
** Struct:  CameraGrid
**
** Purpose: Structure that contains grid data for Camera (mainly used inside
** VCameraViewportHandler).
**
**
...
{
	public const float RANGE_MIN = 0.0f;
	public const float RANGE_MID = 0.5f;
	public const float RANGE_MAX = 1.0f;

	[SerializeField][Range(RANGE_MIN, RANGE_MAX)] private float _centerX;
	[SerializeField][Range(RANGE_MIN, RANGE_MAX)] private float _centerY;
	[SerializeField][Range(RANGE_MIN, RANGE_MAX)] private float _horizontalMin;
	[SerializeField][Range(RANGE_MIN, RANGE_MAX)] private float _horizontalMax;
	[SerializeField][Range(RANGE_MIN, RANGE_MAX)] private float _verticalMin;
	[SerializeField][Range(RANGE_MIN, RANGE_MAX)] private float _verticalMax;
