...
#region Getters/Setters:
	...
	public virtual void FollowTarget(VCamera _camera, Vector3 _target) { /*...*/ }	

	/// <summary>Follows target [overrides Target's transform].</summary>
	/// <param name="_target">Target to follow.</param>
	public virtual void FollowTarget(Vector3 _target) { /*...*/ }
	...
	{
		return /*GetFollowingDirection(vCamera.targetRetriever.GetTargetPosition());*/ Vector3.zero;
	}
	...
	{
		return vCamera.GetFocusDisplacement();
	}
